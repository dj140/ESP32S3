...
// #define DRV2605_DEBUG_PORT  Serial
#ifdef DRV2605_DEBUG_PORT
#ifdef ARDUINO
#define DRV2605_DEBUG(fmt, ...)         AXP_DEBUG_PORT.printf_P((PGM_P)PSTR(fmt), ##__VA_ARGS__)
#else
#define DRV2605_DEBUG(...)              printf(__VA_ARGS__)
#endif
