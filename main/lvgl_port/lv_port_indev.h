...
class TP_FT3168 {
    ...
    public:
        ...
        inline bool i2cInit()
        {
            ...
            if (ret != ESP_OK) {
                ESP_LOGD(TAG1, "I2C config failed");
                return false;
            }
            ...
            if (ret != ESP_OK) {
                ESP_LOGD(TAG1, "I2C driver install failed");
                return false;
            }
            return true;
        }
