...
void Test_Page_View::Create(lv_obj_t* root)
{

    lv_obj_t* ui_Test_Page = lv_obj_create(root);
    lv_obj_remove_style_all(ui_Test_Page);
    lv_obj_clear_flag(ui_Test_Page, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_obj_clear_flag(ui_Test_Page, LV_OBJ_FLAG_GESTURE_BUBBLE);      /// Flags
    lv_obj_set_style_bg_color(ui_Test_Page, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_Test_Page, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_size(ui_Test_Page, TFT_HOR_RES, TFT_VER_RES);
    lv_obj_set_align(ui_Test_Page, LV_ALIGN_CENTER);
    ui.cont = ui_Test_Page;

    lv_obj_t * menu = lv_menu_create(ui_Test_Page);
    ...
    cont = create_slider(section, LV_SYMBOL_SETTINGS, "Brightness", 30, 255, 150);
    ui.Brightness = lv_obj_get_child(cont, 2);
    ...
    ui.sidebar = lv_obj_get_child(cont, 2);
